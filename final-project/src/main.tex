...
\usepackage[colorlinks=true, allbordercolors={0 0 0}, pdfborderstyle={/S/U/W 1}, linkcolor=blue,urlcolor=blue,bookmarksopen=true, urlbordercolor=cyan, citecolor=red]{hyperref}  % hyperlinks
...
\def\span{\ensuremath{\mbox{span}}}
\def\re{\ensuremath{\mbox{Re}}}
\def\im{\ensuremath{\mbox{Im}}}
\def\ord{\ensuremath{\mbox{ord}}}
\def\mult{\ensuremath{\mbox{mult}}}
\def\ind{\ensuremath{\mbox{ind}}}
\def\interior{\ensuremath{\mbox{int}}}
\def\Res{\ensuremath{\mbox{Res}}}
\def\deg{\ensuremath{\mbox{deg}}}
...
% Title Info
\title{Holomorphic Functional Calculus}
\author{Martín Prado}
